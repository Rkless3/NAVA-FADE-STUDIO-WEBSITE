    ...
    if (
        ...
        */
        ...
        if (
            ...
            $error = "Unable to add service. Please try again.";
        }
...
<head>
    ...
    <title>
        Add Service | NAVA Fade Studio Admin
    </title>
...
<div class="dashboard">
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <p>
                Add a new service to the NAVA Fade Studio
                service list.
            </p>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            placeholder="e.g. haircut.jpg"
                            maxlength="255"
                        >

                        <small class="form-help">

                            Use an image filename already
                            inside
